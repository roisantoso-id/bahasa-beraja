        ...
        <CommunityContent>
          ...
          <CommunityImageContainer style={{ display: 'flex', flexDirection: 'row', alignItems: 'center', justifyContent: 'center', gap: '32px', marginBottom: 16 }}>
            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
              <CommunityImage src={require('../assets/wechat_group.jpg')} alt="微信群二维码" style={{ width: 180, height: 180, borderRadius: 16, border: '3px solid #09bb07', boxShadow: '0 4px 16px #09bb0733' }} />
              <div style={{ marginTop: 8, fontWeight: 'bold', fontSize: 18, color: '#09bb07', textAlign: 'center' }}>
            ...
            <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center' }}>
              ...
              <div style={{ color: '#888', fontSize: '13px', marginTop: 4, textAlign: 'center' }}>
